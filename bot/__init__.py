...
DEFAULT_START_TEXT = (
    ...
    "Here you can contact @Yeageristbotsdev "
    ...
    "ℹ️ Subscribe @Animemusicarchive6 if you 😍 using this bot❗️❣️"
)
...
ONLINE_CHECK_START_TEXT = get_config(
    ...
    (
        ...
        "I am offical bot to contact my master "
        "https://t.me/Yeageristbotsdev\n\n\n"
        "ℹ️ Subscribe@Animemusicarchive6 if you 😍 using this bot❗️❣️"
    )
)
# message to indicate,
